        ...
        <ul>
            <?php while ($job = mysqli_fetch_assoc($jobs_result)): ?>
                ...
                while ($row = mysqli_fetch_assoc($skills_result)) {
                    $required_skills[] = strtolower($row['skill']);
                }
                ...
                <li>
                    ...
                    <em>Required Skills:</em> <?= !empty($required_skills) ? implode(', ', array_map('htmlspecialchars', $required_skills)) : 'Not specified' ?><br>
